...
batch_size = 32
passes = 40
save_acc_threshold = 0.7
mybci.dataset_loading.seed = "dsifhusvbfuoerhfsdojndis"
...
for index in range(1, passes+1):
    ...
    for dataset_dir in datasets_directories:
        ...
        # testing
        save_model = True
        for dataset_file, test_data in test.items():
            test_results[dataset_dir][dataset_file] = {}
            for i in [1, 2]:
                ...
                test_results[dataset_dir][dataset_file][f'{i}'] = temp_results
