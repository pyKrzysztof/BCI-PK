...
dataset_path = 'datasets/Krzychu'
test_target = '2006_1'
exclude = ['03', '04', '05', '08']
exclude = ['2805', '0406']

def train_and_test_model(SEED):
    utils.set_random_seed(SEED)
    tf.config.experimental.enable_op_determinism()

    train_dataset, excluded = load_all_datasets(dataset_path, exclude_matching=[test_target, *exclude], load_excluded=True, verbose=True)
    target_dataset = None
